...
import { getStorage, ref ,uploadBytesResumable, getDownloadURL,deleteObject } from 'https://www.gstatic.com/firebasejs/10.11.0/firebase-storage.js';
    ...
    const firebaseConfig = {
        apiKey: "AIzaSyDyWwrekOSOA7PUDfUt8GfG-WCPz3W-sXs",
        authDomain: "lab2-3dbc6.firebaseapp.com",
        projectId: "lab2-3dbc6",
        storageBucket: "lab2-3dbc6.appspot.com",
        messagingSenderId: "375106708173",
        appId: "1:375106708173:web:85bd1ad5be47d31bc4bf84"
      };
...
const storageRef = ref(storage);
    ...
    document.getElementById('submit2').addEventListener("click", async () => {
        ...
        const storageRef = ref(storage, 'gs://lab2-3dbc6.appspot.com/'+file.name);
...
uploadTask.on('state_changed', 
  ...
  () => {
    ...
    document.getElementById('submit7').addEventListener("click", async () => {
        const file= document.getElementById('file').files[0];
        getDownloadURL(ref(storage, 'gs://lab2-3dbc6.appspot.com/'+file.name))
        .then((url) => {
    ...
    document.getElementById('submit8').addEventListener("click", async () => {
        const file= document.getElementById('file').files[0];
        const desertRef = ref(storage,  'gs://lab2-3dbc6.appspot.com/'+file.name);
